"""
This file will create the class structure of a simulation, it will expose a class with a method which, upon being
...
class Hub:
    """
    This object will contain references to all classes created
